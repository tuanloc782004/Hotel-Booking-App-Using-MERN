    ...
    return room && (
        <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
            ...
            <div className='flex flex-col md:flex-row md:justify-between gap-4 mt-10'>
                <div className='flex flex-col'>
                    ...
                    <div className='flex flex-wrap items-center mt-3 mb-6 gap-4'>
                        {room.amenities.map((item, index) => (
                            <div key={index} className='flex items-center gap-2 px-3 py-2 rounded-lg gb-gray-100'>
                ...
                {/* Room Price*/}
                <p className='text-2xl font-medium'>From ${room.pricePerNight}/night</p>
            </div>
                ...
                <div className='flex flex-col flex-wrap md:flex-row items-start md:items-center gap-4 md:gap-10 text-gray-500'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <input type="number" id='guests' placeholder='0'
                            className='max-w-24 rounded border border-gray-300 px-3 py-2 mt-1.5 outline-none' required />
                    </div>
